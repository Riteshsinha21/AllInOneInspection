...
extension CalendarView {
    ...
    public struct Style {
        ...
        public static var headerTextColor = UIColor.black
        public static var headerTextColor1 = UIColor.lightGray

        public static var headerFontName: String = "Helvetica Bold"
         public static var headerFontName1: String = "Helvetica"
        
        //Common
        public static var cellShape                 = CellShapeOptions.bevel(8.0)
        ...
        //Weekend Style
        public static var cellTextColorWeekend      = UIColor.red
