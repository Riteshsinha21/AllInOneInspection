...
class Gallery: NSObject {
    ...
    func createAlbum() {
        PHPhotoLibrary.shared().performChanges({
            PHAssetCollectionChangeRequest.creationRequestForAssetCollection(withTitle: Gallery.albumName)   // create an asset collection with the album name
        }) { success, error in
            if success {
    ...
    func fetchAssetCollectionForAlbum() -> PHAssetCollection? {
        ...
        fetchOptions.predicate = NSPredicate(format: "title = %@", Gallery.albumName)
